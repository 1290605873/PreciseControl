                        ...
                        <div :style="{position: 'relative',height: (360*3/5)+'px'}">
                            ...
                            <template v-if="!!item.wrongItem" >
                                <span
                                    ...
                                    :key="idx"
                                    :style="{
                                        top:((items.Top/item.InitHeight*100).toFixed(2))+'%',
                                        left:((items.Left/item.InitWidth*100).toFixed(2))+'%',
                                        width: (items.Width/item.InitWidth*100).toFixed(2)+'%',
                                        height: (items.Height/item.InitHeight*100).toFixed(2)+'%'}">
                                    </span>
                            </template>
...
<script src='@/views/AICameraPhotograph/AICameraPhotograph.js'>
</script>
