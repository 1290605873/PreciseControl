...
export default {
    ...
    methods: {
        ...
        GetFiveLocationType(){
          let p = {}
          this.$api.GetFiveLocationType(p).then(res => {
            console.log(res)
            if(res.IsSuccess){
        ...
        GetPicList() {
            ...
            let param = {
                ...
                SceneType: this.scene || '00000000-0000-0000-0000-000000000000'
            }
        ...
        // 双击图片
        dbcheck(val) {
            this.reviewImage.data.userName = this.Auditor
            this.reviewImage.data.val = val
            this.reviewImage.data.picType = 1
            this.reviewImage.data.AttrList =this.$utils.deepCopy(this.violationsList)
            let p = {
