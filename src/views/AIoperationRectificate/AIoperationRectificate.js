...
export default {
    ...
    created () {
        ...
        window['toserver'] = (data, index) => {
            ...
            this.$api.ReformAuditPic(param).then(res => {
                if (res.IsSuccess) {
                    this.message('审核成功', 1);
                } else {
                    this.message('审核失败', -1);
    ...
    methods: {
        ...
        GetAiPhotoSearch() {
            ...
            let param = {
                ...
                AttrCode:  this.Violations.AttrCode,//违规项
                IsAudit: this.IsViolation.code,//是否违规 -1全部 0未违规 1违规
                AuditStatus: this.IsToexamine.code,//审核状态：0-无 1-未审核 2-已审核
                SourceType: 2,//来源类型 0无 1自查 2 ai智能整改
            ...
            // console.log('获取列表param--->', JSON.stringify(param, null, 2));
        ...
        async comInspectAuditPic () { // 审核
            ...
            // console.error(JSON.stringify(this.checkedList, null, 2));
            ...
            param.AuditOptionList = this.checkedList.Coordinate.map(v=>{
                return {
                    "AttrCode": this.checkedList.AttrCode, // 违规项
                    "AttrTxt": this.checkedList.AttrTxt, // 违规项名称
                    "InitHeight": this.checkedList.InitHeight || 0, // 原图高
                    "InitWidth": this.checkedList.InitWidth || 0, // 原图宽
                    "Height": v.Height, // 人体高
                    "Width": v.Width, // 人体宽
                    "Left": v.Left, // 左边距
                    "Top": v.Top // 上边距
            ...
            const res = await this.$api.ReformAuditPic(param)
            console.log('违规项--->',res);
            if (res.IsSuccess) {
