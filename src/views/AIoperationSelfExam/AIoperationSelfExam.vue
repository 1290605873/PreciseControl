	...
	<div class="container">
        ...
        <div class="top" ref="top">
            <el-form inline>
                ...
                <el-form-item label="">
                    <el-cascader :props="cascaderOpt" v-model="Violations.AttrCode" clearable placeholder="请选择检查项"></el-cascader>
                </el-form-item>
                <el-form-item label="">
...
<script src='@/views/AIoperationSelfExam/AIoperationSelfExam.js'>
</script>
