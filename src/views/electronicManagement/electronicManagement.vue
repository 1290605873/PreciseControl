    ...
    <div class="electronicManagement">
        ...
        <el-container>
            <el-main class="right">
                <el-table v-if="taskTabs.code==0"
                    ...
                    <el-table-column show-overflow-tooltip align="" label="巡查时间" width="">
                        <template slot-scope="scope">
                            <span v-text="scope.row.SubTime"></span>
                        </template>
                    </el-table-column>
                ...
                <pagination v-if="taskTabs.code==0"
                            ...
                            class="main-bottom"
                            id="main-bottom"></pagination>
                <el-table v-if="taskTabs.code==1"
                    ...
                    <el-table-column show-overflow-tooltip align="" label="操作" width="">
                        <template slot-scope="scope">
                            <el-button size="mini" :disabled="scope.row.ReformState!=2&&scope.row.ReformState!=4" type="primary" @click="openReformDialog(scope.row.Id,scope.row.ReformState)">详情</el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <pagination v-if="taskTabs.code==1"
                            v-show="pageNation_refrom.total>0"
                            :total="pageNation_refrom.total"
                            :page.sync="pageNation_refrom.pageNum"
                            :limit.sync="pageNation_refrom.countPerPage"
                            class="main-bottom"
                            @pagination="onReformPageNation"
                            id="main-bottom_"></pagination>
            </el-main>
            <el-dialog
                    :title="title"
            ...
            <el-dialog
                    title="整改详情"
                    top="10vh"
                    v-if="reformDetailDialog.show"
                    :visible.sync="reformDetailDialog.show"
                    width="70%"
                    :close-on-click-modal="false"
            >
                <div class="maxDialog">
            ...
            <el-dialog
                    title="巡查任务详情"
                    top="10vh"
                    v-if="partrolDetailsDialog.show"
                    :visible.sync="partrolDetailsDialog.show"
                    width="70%"
                    calss="PatrolTasksDetails"
                    :close-on-click-modal="false"
            >
                <div class="maxDialog">
                    ...
                    <!--<div class="content">-->
                        <!--<ul>-->
                            <!--<li>-->
                                <!--<p class="left">单位名称:</p>-->
                                <!--<p>{{partrolDetailsDialog.Content.Name}}</p>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<p class="left">地址:</p>-->
                                <!--<p>{{partrolDetailsDialog.Content.Address}}</p>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<p class="left">巡查位置:</p>-->
                                <!--<p>{{partrolDetailsDialog.Content.Address}}</p>-->
                            ...
                            <!--<li>-->
                                <!--<div style="border-right:1px solid #ccc;">-->
                                    <!--<p class="left">所属街道:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.LocationName}}</p>-->
                                <!--</div>-->
                                <!--<div>-->
                                    <!--<p class="left">所属社区:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.CommunityName}}</p>-->
                                <!--</div>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<p class="left">巡查时间:</p>-->
                                <!--<p>{{partrolDetailsDialog.Content.InspectDate}}</p>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<div style="border-right:1px solid #ccc;">-->
                                    <!--<p class="left">巡查类型:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.InspectType}}</p>-->
                                <!--</div>-->
                                <!--<div>-->
                                    <!--<p class="left">巡查人员:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.InspectUserName}}</p>-->
                                <!--</div>-->
                            <!--</li>-->
                            <!--<li>-->
                                <!--<div style="border-right:1px solid #ccc;">-->
                                    <!--<p class="left">巡查结果:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.InspectResult}}</p>-->
                                <!--</div>-->
                                <!--<div>-->
                                    <!--<p class="left">结果处理:</p>-->
                                    <!--<p>{{partrolDetailsDialog.Content.ProcessResult}}</p>-->
                                <!--</div>-->
                            <!--</li>-->
                        <!--</ul>-->
                    <!--</div>-->
            ...
            <el-dialog
                    title="电子巡查详情"
                    top="10vh"
                    v-if="electronicInspectDialog.show"
                    :visible.sync="electronicInspectDialog.show"
                    width="70%"
                    calss="PatrolTasksDetails"
                    :close-on-click-modal="false"
            >
...
<script src="@/views/electronicManagement/electronicManagement.js">
</script>
